...
let Profile = () => {
    ...
    let ReviewItem = ReviewData.map(review => <Review avatar={review.avatar} likes={review.likes}
    ...
    return (
        <div>
            ...
            <PersonalInformation avatar={PersonalData[0].avatar}
                                 name={PersonalData[0].name} city={PersonalData[0].city} born={PersonalData[0].born}
                                 education={PersonalData[0].education}
                                 site={PersonalData[0].site}/>
