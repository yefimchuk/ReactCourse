...
import {getProfileSelector, getSliceProfileSelector,} from "../../../BLL/ProfilePage/profileSelector";
import {useParams} from "react-router";
import {clearProfileId, GetNewProfile} from "../../../BLL/ProfilePage/profilePage";
...
console.log(profileData)
        ...
        return () => dispatch(clearProfileId())
